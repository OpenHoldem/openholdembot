...
namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Graphics::Canvas::ICanvasDrawingSession>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall DrawInk(void*) noexcept = 0;
            virtual int32_t __stdcall DrawInkWithHighContrast(void*, bool) noexcept = 0;
    ...
    struct consume_Microsoft_Graphics_Canvas_ICanvasDrawingSession
    {
        ...
        auto DrawInk(param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes) const;
        auto DrawInk(param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes, bool highContrast) const;
