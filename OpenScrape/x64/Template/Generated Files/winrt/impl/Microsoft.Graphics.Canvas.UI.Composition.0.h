...
namespace winrt::impl
{
    ...
    {
        auto CreateCompositionGraphicsDevice(winrt::Windows::UI::Composition::Compositor const& compositor, winrt::Microsoft::Graphics::Canvas::CanvasDevice const& canvasDevice) const;
        auto CreateCompositionSurfaceForSwapChain(winrt::Windows::UI::Composition::Compositor const& compositor, winrt::Microsoft::Graphics::Canvas::CanvasSwapChain const& swapChain) const;
        auto GetCanvasDevice(winrt::Windows::UI::Composition::CompositionGraphicsDevice const& graphicsDevice) const;
        auto SetCanvasDevice(winrt::Windows::UI::Composition::CompositionGraphicsDevice const& graphicsDevice, winrt::Microsoft::Graphics::Canvas::CanvasDevice const& canvasDevice) const;
        auto CreateDrawingSession(winrt::Windows::UI::Composition::CompositionDrawingSurface const& drawingSurface) const;
        auto CreateDrawingSession(winrt::Windows::UI::Composition::CompositionDrawingSurface const& drawingSurface, winrt::Windows::Foundation::Rect const& updateRect) const;
        auto CreateDrawingSession(winrt::Windows::UI::Composition::CompositionDrawingSurface const& drawingSurface, winrt::Windows::Foundation::Rect const& updateRectInPixels, float dpi) const;
        auto Resize(winrt::Windows::UI::Composition::CompositionDrawingSurface const& drawingSurface, winrt::Windows::Foundation::Size const& sizeInPixels) const;
    };
