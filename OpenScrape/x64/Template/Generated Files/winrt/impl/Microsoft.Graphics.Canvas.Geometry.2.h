...
WINRT_EXPORT namespace winrt::Microsoft::Graphics::Canvas::Geometry
{
        ...
        impl::require<CanvasGeometry, winrt::Windows::Graphics::IGeometrySource2D>
    {
        ...
        static auto CreateInk(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes);
        static auto CreateInk(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance);
