...
namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Graphics::Canvas::Geometry::ICanvasGeometryStatics>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall CreateInk(void*, void*, void**) noexcept = 0;
            virtual int32_t __stdcall CreateInkWithTransformAndFlatteningTolerance(void*, void*, winrt::Windows::Foundation::Numerics::float3x2, float, void**) noexcept = 0;
    ...
    struct consume_Microsoft_Graphics_Canvas_Geometry_ICanvasGeometryStatics
    {
        ...
        auto CreateInk(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes) const;
        auto CreateInk(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const;
