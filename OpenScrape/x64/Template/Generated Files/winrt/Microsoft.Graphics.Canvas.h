...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_Graphics_Canvas_ICanvasDrawingSession<D>::DrawInk(param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Canvas::ICanvasDrawingSession)->DrawInk(*(void**)(&inkStrokes)));
    }
    template <typename D> auto consume_Microsoft_Graphics_Canvas_ICanvasDrawingSession<D>::DrawInk(param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes, bool highContrast) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Canvas::ICanvasDrawingSession)->DrawInkWithHighContrast(*(void**)(&inkStrokes), highContrast));
    }
    ...
    struct produce<D, winrt::Microsoft::Graphics::Canvas::ICanvasDrawingSession> : produce_base<D, winrt::Microsoft::Graphics::Canvas::ICanvasDrawingSession>
    {
        ...
        int32_t __stdcall DrawInk(void* inkStrokes) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().DrawInk(*reinterpret_cast<winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::UI::Input::Inking::InkStroke> const*>(&inkStrokes));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall DrawInkWithHighContrast(void* inkStrokes, bool highContrast) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().DrawInk(*reinterpret_cast<winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::UI::Input::Inking::InkStroke> const*>(&inkStrokes), highContrast);
            return 0;
        }
        catch (...) { return to_hresult(); }
