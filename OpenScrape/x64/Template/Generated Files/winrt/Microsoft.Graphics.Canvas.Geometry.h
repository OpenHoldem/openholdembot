...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_Graphics_Canvas_Geometry_ICanvasGeometryStatics<D>::CreateInk(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes) const
    {
        void* geometry{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Canvas::Geometry::ICanvasGeometryStatics)->CreateInk(*(void**)(&resourceCreator), *(void**)(&inkStrokes), &geometry));
        return winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry{ geometry, take_ownership_from_abi };
    }
    template <typename D> auto consume_Microsoft_Graphics_Canvas_Geometry_ICanvasGeometryStatics<D>::CreateInk(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance) const
    {
        void* geometry{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Canvas::Geometry::ICanvasGeometryStatics)->CreateInkWithTransformAndFlatteningTolerance(*(void**)(&resourceCreator), *(void**)(&inkStrokes), impl::bind_in(transform), flatteningTolerance, &geometry));
        return winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry{ geometry, take_ownership_from_abi };
    }
    ...
    struct produce<D, winrt::Microsoft::Graphics::Canvas::Geometry::ICanvasGeometryStatics> : produce_base<D, winrt::Microsoft::Graphics::Canvas::Geometry::ICanvasGeometryStatics>
    {
        ...
        int32_t __stdcall CreateInk(void* resourceCreator, void* inkStrokes, void** geometry) noexcept final try
        {
            clear_abi(geometry);
            typename D::abi_guard guard(this->shim());
            *geometry = detach_from<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry>(this->shim().CreateInk(*reinterpret_cast<winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const*>(&resourceCreator), *reinterpret_cast<winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::UI::Input::Inking::InkStroke> const*>(&inkStrokes)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall CreateInkWithTransformAndFlatteningTolerance(void* resourceCreator, void* inkStrokes, winrt::Windows::Foundation::Numerics::float3x2 transform, float flatteningTolerance, void** geometry) noexcept final try
        {
            clear_abi(geometry);
            typename D::abi_guard guard(this->shim());
            *geometry = detach_from<winrt::Microsoft::Graphics::Canvas::Geometry::CanvasGeometry>(this->shim().CreateInk(*reinterpret_cast<winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const*>(&resourceCreator), *reinterpret_cast<winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::UI::Input::Inking::InkStroke> const*>(&inkStrokes), *reinterpret_cast<winrt::Windows::Foundation::Numerics::float3x2 const*>(&transform), flatteningTolerance));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
WINRT_EXPORT namespace winrt::Microsoft::Graphics::Canvas::Geometry
{
    ...
    inline auto CanvasGeometry::CreateInk(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes)
    {
        return impl::call_factory<CanvasGeometry, ICanvasGeometryStatics>([&](ICanvasGeometryStatics const& f) { return f.CreateInk(resourceCreator, inkStrokes); });
    }
    inline auto CanvasGeometry::CreateInk(winrt::Microsoft::Graphics::Canvas::ICanvasResourceCreator const& resourceCreator, param::iterable<winrt::Windows::UI::Input::Inking::InkStroke> const& inkStrokes, winrt::Windows::Foundation::Numerics::float3x2 const& transform, float flatteningTolerance)
    {
        return impl::call_factory<CanvasGeometry, ICanvasGeometryStatics>([&](ICanvasGeometryStatics const& f) { return f.CreateInk(resourceCreator, inkStrokes, transform, flatteningTolerance); });
    }
