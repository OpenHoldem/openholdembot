...
CString ListOfSymbols() {
  ...
  list += RangeOfSymbolsHex("i%cbuttonhotkey", 0, 15);
  list += RangeOfSymbolsHex("i%cbuttondefaultlabel", 0, 15);
  list += RangeOfSymbolsHex("i%cbuttonclickmethod", 0, 15);
  list += RangeOfSymbolsHex("i86%cbuttonclickmethod", 0, 15);
...
CString ListOfRegions() {
  ...
  list += "c0limits ";
  list += RangeOfSymbols("c0limits%i", 0, 9);
  list += RangeOfSymbolsHex("i%cbutton", 0, 15);
  list += RangeOfSymbolsHex("i%clabel", 0, 15);
  list += RangeOfSymbolsHex("i%cstate", 0, 15);
  list += RangeOfSymbolsHex("i86%cbutton", 0, 15);
  list += RangeOfSymbolsHex("i86%cstate", 0, 15);
